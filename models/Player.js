  ...
  stats: {
    ...
    fiveOhOneStats: {
      single: {
        ...
        total180s: { type: Number, default: 0 },
        total180ShotsAttempt: { type: Number, default: 0 },
        total141Checkout: { type: Number, default: 0 },
        totalDoubleShots: { type: Number, default: 0 },
        totalDoubleShotsAttempt: { type: Number, default: 0 },
        total9DartFinish: { type: Number, default: 0 },
      },
      multi: {
        totalfive0OneGamesPlayed: { type: Number, default: 0 },
        fiveOhOneGamesWon: { type: Number, default: 0 },
